 ...
 *
 * Example:
 * [controller, spawnPos, stretcher, subjectName] call TFWW_Hades_Medical_fnc_createSubject
 */
...
private _spawnSubjecTFWWtion = [
    QGVAR(spawnSubjecTFWWtion),
...
[_controller, 0, ["ACE_MainActions", QGVAR(spawnMainAction)], _spawnSubjecTFWWtion] call ACEFUNC(interact_menu,addActionToObject);
