 ...
 *
 * Example:
 * [controller, medicalSpawnPos] call TFWW_Hades_Medical_fnc_init
 */
...

{
    ...
    [_controller, _spawnPos, _stretcher, _subjectName] call TFWW_Hades_Medical_fnc_createSubject;
} forEach _stretchers;
...
{
    _x params ["_stretcher", "_subjectName"];
    [_controller, _stretcher, _subjectName] call TFWW_Hades_Medical_fnc_removeSubject;
} forEach _stretchers;
...

{
    ...
    private _specificDamageAction = [
        ...
        {(_this select 2) call TFWW_Hades_Medical_fnc_specific_bodyParTFWWtions},
...

{
    ...
    private _randomDamageAction = [
        ...
        {(_this select 2) call TFWW_Hades_Medical_fnc_applyRandomDamage},
        [_controller, _stretcher]
    ] call ACEFUNC(interact_menu,createAction);
...
private _instructorDisplayOpen = [
    ...
    {(_this select 2) call TFWW_Hades_Medical_fnc_instructorDisplay},
