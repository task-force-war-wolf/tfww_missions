 ...
 *
 * Example:
 * [this] call TFWW_Hades_fnc_rangeMachineGunTargetGroups
 */
...
{
    [_x, 1] call TFWWFUNC(shootingrange,animateTarget);
} forEach [ALL_TARGETS];
//////////////
...

{
    ...
    private _action = [
        ...
        "x\cba\addons\ai\iconinvisibletarget.paa",
        {
            ...
            {
                [_x, _state] call TFWWFUNC(shootingrange,animateTarget);
                _x setVariable [QTFWWGVAR(shootingrange,stayDown), true, true];
