 ...
 *
 * Example:
 * [this, spawnPad, "ground"] call TFWW_Hades_fnc_vehicleSpawner
 */
...
private _groundVehicles = [
    ...
    ["TFWWs_Arcadian_B_Black"],
    ["TFWWs_Arcadian_B_Green"],
    ["TFWWs_Arcadian_B_Tan"],
    ["TFWWs_Polaris_B_Black"],
    ["C_SUV_01_F"],
    ["TFWWs_Offroad_B_Black"],
    ["TFWWs_Offroad_B_Covered_Black"],
    ["C_Offroad_02_unarmed_F"],
    ["TFWWs_Van_Transport_B_Black"]
];

private _airVehicles = [
    // ["classname", "specialType"]
    ["TFWWs_MELB_B_MH6M_Theseus_Black"],
    ["TFWWs_MELB_B_AH6M_L_Theseus_Black"],
    ["TFWWs_MELB_B_AH6M_M_Theseus_Black"],
    ["TFWWs_MELB_B_AH6M_H_Theseus_Black"],
    ["TFWWs_Heli_B_Wildcat_Theseus_Unarmed"],
    ["TFWWs_Heli_B_Wildcat_Theseus"],
    ["CUP_B_UH60M_US"],
...
private _engineerRepairVehicles = [
    // ["classname", "specialType"]
    ["TFWWs_Arcadian_B_Black", "engineer_repair"]
];
                ...
                "",
                {
                    ...
                    if (count (_spawnPos nearEntities 5) == 0) then {
                        ...
                        if (_spawnedVehicle isKindOf "Air") then {
                            ["TFWWgt_supplies_CanisterFuel_Theseus", _spawnedVehicle] call ACEFUNC(cargo,loadItem); // TODO: REVERT IF GTArmory is not updated.
                        };
