 ...
 *
 * Example:
 * [controller, stretcher, bodyPart] call TFWW_Hades_Medical_fnc_specific_projectileTypeActions
 */
...
private _actions = [];
{
    ...
    private _projectileTypeAction = [
        ...
        {},
        {true},
        {(_this select 2) call TFWW_Hades_Medical_fnc_specific_severityActions},
