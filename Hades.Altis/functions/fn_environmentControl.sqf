 ...
 *
 * Example:
 * [controller] call TFWW_Hades_fnc_environmentControl
 */
...
// Add overcast option
private _overcasTFWWtion = [
    QGVAR(overcasTFWWtion),
    "Set Overcast",
...
[_controller, 0, ["ACE_MainActions"], _overcasTFWWtion] call ACEFUNC(interact_menu,addActionToObject);
